...
cryptographically signs a message ``I pay 5 coins to Bob'', see Figure~\ref{fig:chain-spend}.
This system
...
and how does Bob know that this value hasn't already been spent, see Figure~\ref{fig:chain-double-spend} for an example double spend. In B-Money~\cite{b-money} the solution is to involve multiple trusted authorities that host a public copy
