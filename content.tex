...
invalidated by a prior transaction.  Distributed Transaction Validation
...
to repeatedly try different input data values. Transaction block data can be
altered without changing the transaction semantics because the transaction block
format includes a ‘nonce’ field for this purpose.
...
from any other in the transaction network.
