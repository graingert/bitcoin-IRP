...
pdftitle={Anonymity in the Bitcoin protocol and other Digitial Currencies},%<!CHANGE!
...
\title{Anonymity in the Bitcoin protocol and other Digitial Currencies}
%
%
...
\author{Thomas~A.~Grainger\protect\\
% note need leading \protect in front of \\ to get a newline within \thanks as
% \\ is fragile and will error, could use \hfil\break instead.
E-mail: tag1g09@ecs.soton.ac.uk
}% <-this % stops a space
