...
and how does Bob know that this value hasn't already been spent, see Figure~\ref{fig:chain-double-spend} for an example double spend. In [Cite]
...
\begin{figure}[htb]
    ...
    \caption{A chain of digital signatures representing value transfer with a double spend.
