...
\setlength\fboxrule{0.5pt}
  \fbox{
    \begin{minipage}{14em}
      \includegraphics[width=10em,height=4em]{pix/colbud_logo}
      \includegraphics[width=4em,height=4em]{pix/elte_logo} \\
      \includegraphics[width=10em,height=4em]{pix/dynanets_logo}
      \includegraphics[width=4em,height=4em]{pix/aitia_logo}
    \end{minipage}
  }
}

\headerbox{Problem}{name=problem,column=0,row=0}{
Sampling networks always involves the act of aggregation (e.g., when collecting longitudinal samples of networks). We sutdy how the cumulation window length effects the properties of the aggregated network~\textcite{satoshi}.

\includegraphics[width=\linewidth]{pix/time_windows}
}
...
\includegraphics[angle=-90,width=0.98\linewidth]{pix/PA_and_ER_Models_statisticalMeasures}
}
...
\vspace{-0.2em}
\begin{center}
  \includegraphics[angle=-90,width=0.49\linewidth]{pix/CPA_3d_snapshot}
  \includegraphics[angle=-90,width=0.49\linewidth]{pix/CPA_3d_cumulative}
\end{center}
\vspace{-0.2em}
...
\vspace{-0.2em}
\begin{center}
  \includegraphics[angle=-90,width=0.49\linewidth]{pix/ER1_cumulativeDegrees}
  \includegraphics[angle=-90,width=0.49\linewidth]{pix/CPA_cumulativeDegrees}
\end{center}
}
